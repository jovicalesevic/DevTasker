...
export function validatePendingSessionDraft(input: PendingSession): PendingSession | null {
...
export function normalizePendingSession(value: unknown): PendingSession | null {
  if (!value || typeof value !== "object") return null;
...
export function normalizeWeeklySummary(value: unknown): WeeklySummary | null {
  if (!value || typeof value !== "object") return null;
...
export function isPersistedEnvelope(value: unknown): value is PersistedStateEnvelope {
  if (!value || typeof value !== "object") return false;
  const v = value as { schemaVersion?: unknown; data?: unknown };
  return typeof v.schemaVersion === "number" && typeof v.data === "object";
}

export function migrateState(input: Partial<AppState>, _fromVersion: number): AppState {
  return normalizeAppState(input);
}

export function sortState(input: AppState): AppState {
...
export function normalizeDueInput(value: string): string | null {
