import { CURRENT_SCHEMA_VERSION, DEFAULT_PROJECT_NAME, DIFF_VIEW_MODE_KEY, SNAPSHOT_KEY, STORAGE_KEY } from "./constants.js";
import { loadState as loadStateFromStorage, mergeState as mergeAppState, replaceState as replaceAppState, saveState as saveStateToStorage } from "./state.js";
import { createEmptyState, isPersistedEnvelope, migrateState, normalizeAppState, sortState, validatePendingSessionDraft, validateTaskDraft } from "./validation.js";
import { byId, byIdOptional, escapeHtml, formatDate, formatDay, nowIso, priorityLabel, startOfWeek, statusLabel, uid } from "./utils.js";
import { buildDiffPreview } from "./diffPreview.js";
import { captureSnapshot, getSnapshots as getSnapshotsFromStorage, setSnapshots as setSnapshotsToStorage, snapshotDataCounts } from "./snapshots.js";
import { commitSession as commitSessionToState, flushPendingSessions as flushPendingSessionsFromQueue } from "./sync.js";
import { exportBackupJson as exportBackupJsonFile, importBackupFromFile, resetAppData as resetAllAppData, undoLastDestructiveAction as undoFromSnapshots } from "./backup.js";
import { averageLeadTimeHours as averageLeadTimeHoursFromState, calculateWorklogStreak as calculateWorklogStreakFromSessions, latestTaskActivity as latestTaskActivityFromState, nextUpScore as nextUpScoreForTask, predictTodayItems as predictTodayItemsFromState, topBlockers as topBlockersFromSessions, weeklyTrendText as weeklyTrendTextFromState } from "./analytics.js";
...
import { closeHelpModal as hideHelpModal, isHelpModalOpen, openHelpModal as showHelpModal } from "./helpModal.js";
